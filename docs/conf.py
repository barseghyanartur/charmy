...
# sphinx-quickstart on Sat Oct 10 00:47:55 2015.
#
...
latex_documents = [
  ('index', 'charmy.tex', u'charmy Documentation',
...
texinfo_documents = [
  ('index', 'charmy', u'charmy Documentation',
   u'Artur Barseghyan <artur.barseghyan@gmail.com>', 'charmy', 'One line description of project.',
   'Miscellaneous'),
]
